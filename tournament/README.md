...
1. Click on **"Schedule"** to view matches
2. Click **"Add Result"** on any match card to enter the score
3. Watch the **"Standings"** update automatically as results are added
4. Filter matches by round using the filter buttons
